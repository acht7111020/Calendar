...
public class JournalInputActivity extends ActionBarActivity {
    ...
    public void addJournalNow(EditText title,EditText descrip,EditText mDate) {
        ...
        if (sTitle.equalsIgnoreCase("")) {
            ...
            long listid=db.createJournal(journal);
            journal.setId(listid);
            Log.e(ACTIVITY_TAG, "data added");
            title.setText("");
            descrip.setText("");
//            adapt.add(task);
